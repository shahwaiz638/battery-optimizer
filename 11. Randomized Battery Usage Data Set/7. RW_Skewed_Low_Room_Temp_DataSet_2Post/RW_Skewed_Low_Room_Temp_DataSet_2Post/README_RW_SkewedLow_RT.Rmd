---
title: "Description of Left Skewed Random Walk Discharging Data Sets"
...
## Files:
RW13.mat -> A Matlab data structure for Battery #RW13

RW13.Rda -> An R data frame containing the same data as the Matlab data structure

RW14.mat -> A Matlab data structure for Battery #RW14

RW14.Rda -> An R data frame containing the same data as the Matlab data structure

RW15.mat -> A Matlab data structure for Battery #RW15

RW15.Rda -> An R data frame containing the same data as the Matlab data structure

RW16.mat -> A Matlab data structure for Battery #RW16

RW16.Rda -> An R data frame containing the same data as the Matlab data structure
...
load("data/R/RW13.Rda")  # loading data
...
# Initialize plot
par(mar=c(6,5,2,2)) # set plot margins
plot(0,xlim = c(ExpStart,ExpEnd),ylim = c(0,2),xaxt="n",
